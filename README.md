...
Overview
Features
User Registration (US_201)
Negative User Registration (US_202)
Logout (US_203)
Login (US_204)
Negative Login Scenarios (US_205)
Order Placement (US_206)
Survey Response (US_207)
Negative Coupon and Gift Card Usage (US_208)
Download Order History (US_209)
Test Environment
Installation
Contributors
...
Provide shipping information and agree to terms.
...
•	Merve Kaya  (QA Tester) (Project Leader)
•	Ümmühan Teke  (QA Tester)
•	Sefa Kahraman  (QA Tester)
